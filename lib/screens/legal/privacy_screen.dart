...
/// As with the Impressum, the title and numbered section headings are UI
/// chrome and are localized below. The intro sentence and the body of each
/// section are the substance of the privacy policy — legal content, not
/// copy — so they are deliberately left in English in every locale rather
/// than machine-translated; see the comment on [ImpressumScreen].
class PrivacyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return LegalScaffold(
      ...
      children: [
        LegalHeading(loc.legalPrivacySectionGeneralInfo),
        const LegalBody(
        ...
        LegalHeading(loc.legalPrivacySectionDataCollection),
        const LegalBody(
        ...
        LegalHeading(loc.legalPrivacySectionRegistration),
        const LegalBody(
        ...
        LegalHeading(loc.legalPrivacySectionAnalytics),
        const LegalBody(
        ...
        LegalHeading(loc.legalPrivacySectionE2ee),
        const LegalBody(
        ...
        LegalHeading(loc.legalPrivacySectionRights),
        const LegalBody(
